    ...
    <div class="flex flex-row flex-wrap flex-grow mt-2">
        ...
        <div class="w-full md:p-3">
            ...
            <div class="bg-white border rounded shadow">
                ...
                <div class="py-5 px-2 md:p-5">
                    <table class="table-auto w-full ">
                        <thead>
                            <tr class="text-left">
                                <th class="px-4 py-2 w-3/4">Title</th>
                                <th class="px-4 py-2">Author</th>
                                <th class="px-4 py-2">Action</th>
                            </tr>
                        </thead>
                        <tbody class="font-bold text-sm">
                            <tr class="bg-trensparent hover:bg-gray-100">
                                ...
                                <td class="border px-4 py-2">
                                    <div class=" md:flex items-center justify-end">
                                        <a class="border bg-gray-100 rounded py-1 px-2 mx-1 flex items-center text-purple-500 hover:text-gray-100 hover:bg-purple-500 my-1 lg:my-0"
                                            href="">
